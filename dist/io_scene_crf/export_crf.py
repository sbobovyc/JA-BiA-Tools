    ...
    for ob in bpy.context.selected_objects:
        ...
        for face in blender_mesh.tessfaces:
            ...
            if not verts_in_face[0] in vert_dict:
                ...
                vert.tangent_x_blend = vtex_specular_colors.data[face.index].color1[0] 
                vert.tangent_y_blend = vtex_specular_colors.data[face.index].color1[1] 
                vert.tangent_z_blend = vtex_specular_colors.data[face.index].color1[2] 
                vert.tangent_w_blend = vtex_specular_alpha.data[face.index].color1[0] # only use the first color for alpha       
            ...
            if not verts_in_face[1] in vert_dict:
                ...
                vert.normal_w_blend = 1.0
                vert.tangent_x_blend = vtex_specular_colors.data[face.index].color2[0] 
                vert.tangent_y_blend = vtex_specular_colors.data[face.index].color2[1] 
                vert.tangent_z_blend = vtex_specular_colors.data[face.index].color2[2] 
                vert.tangent_w_blend = vtex_specular_alpha.data[face.index].color1[0] # only use the first color for alpha              
            ...
            if not verts_in_face[2] in vert_dict:
                ...
                vert.normal_w_blend = 1.0
                vert.tangent_x_blend = vtex_specular_colors.data[face.index].color3[0] 
                vert.tangent_y_blend = vtex_specular_colors.data[face.index].color3[1] 
                vert.tangent_z_blend = vtex_specular_colors.data[face.index].color3[2] 
                vert.tangent_w_blend = vtex_specular_alpha.data[face.index].color1[0] # only use the first color for alpha              
