bl_info = {
    "name": "Jagged Alliance: Back in Action Compiled Resource Format Importer (.crf)",
    "author": "Stan Bobobvych",
    "version": (0, 0, 1),
    "blender": (2, 5, 7),
    "location": "File > Export > CRF (.crf)",
    "description": "CRF Model Format (.crf)",
    "warning": "",
    "wiki_url": "",
    "tracker_url": "",
...
class IMPORT_CRF(bpy.types.Operator):
    '''Import LWO Operator.'''
    bl_idname= "import.crf"
    bl_label= "Import CRF"
    bl_description= "Import a JABiA Compiled Resource File Object"
    bl_options= {'REGISTER', 'UNDO'}

    filepath= StringProperty(name="File Path", description="Filepath used for importing the CRF file", maxlen=1024, default="")
...
def menu_func(self, context):
    self.layout.operator(IMPORT_CRF.bl_idname, text="CRF Object (.crf)")
