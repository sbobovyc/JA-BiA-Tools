...
void fillDialog(HWND hwnd, JABIA_Character * ptr) {
	...
	if(ptr != NULL) {
		...
		*/
		...
		OutputDebugString(buf);
		wsprintf(buf, _T("unsuccessful_locks_picked %i"), character.unsuccessful_locks_picked);
		OutputDebugString(buf);

		wsprintf(buf, _T("successful_doors_forced %i"), character.successful_doors_forced);
		OutputDebugString(buf);
		wsprintf(buf, _T("unsuccessful_doors_forced %i"), character.unsuccessful_doors_forced);
		OutputDebugString(buf);
