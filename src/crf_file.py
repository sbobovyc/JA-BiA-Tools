...
class CRF_data:
    ...
    def unpack(self, file_pointer, peek=False, verbose=False):    
        ...
        self.magick3, self.magick4, self.magick5 = struct.unpack("<III", file_pointer.read(12))
        print self.magick3, self.magick4, self.magick5
        ...
        print self.last_x, self.last_y, self.last_z
        print self.last_i, self.last_j, self.last_k
...
if __name__ == "__main__":
    crf = CRF_file("C:\\Users\\sbobovyc\\Desktop\\bia\\1.03\\bin_win32\environment\hummer_02.crf") 
    crf.unpack()           